...
import TRS_backend.FeatureExtraction.oss_upload_pic as OssUploadPic
...
def get_report_feature(report_set_id):
    ...
    for i in range(len(reports)):
        ...
        url = OssUploadPic.upload_pic(img_feature['andrimg_path'])
        ...
        feature = {'procedure': text_feature['procedures_list'], 'widget': text_feature['problem_widget'],
                   ...
                   'andrimg_path': img_feature['andrimg_path'], 'pic_url':url}
