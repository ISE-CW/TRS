              ...
              <Row>
                <Card v-model="text_feature" style="width: 90%;min-height: 200px">
                  ...
                  <p style="text-align: left">
                    <span style="font-weight: bold">reproduction steps:</span>
                  </p>
                  <p style="text-align: left" v-for="(procedure,index) in text_feature.procedures">
                    <span>{{index+1}}</span>.<span>{{procedure}}</span>
                  </p>
                  <p style="text-align: left"><span style="font-weight: bold">problem widget:</span><span>{{text_feature.problem_widget}}</span></p>
                  <p style="text-align: left"><span style="font-weight: bold">unexpected system behaviour:</span></p>
                  <p style="text-align: left" v-for="(problem,index) in text_feature.problems">
                    <span>{{index+1}}</span>.<span>{{problem}}</span>
                  </p>
                </Card>
              </Row>
